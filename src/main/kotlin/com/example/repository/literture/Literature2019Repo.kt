...
class Literature2019Repo {
    private val instr1215 = """
   ...
   """.trimIndent()
    ...
    val literature2019 = listOf<Questions>(
        ...
        Questions( objective = Objective( "9", "", "", "",
            ...
            "D"
                ...
                Questions( objective = Objective( "10", "Milton! thou should'st be living at this hour. ", "", "",
        ...
        Questions( objective = Objective( "12", instr1215, "", "",
    ...
    Questions( objective = Objective( "13", instr1215, "", "",
    ...
    Questions( objective = Objective( "14", instr1215, "", "",
    ...
    Questions( objective = Objective( "15", instr1215, "", "",
    "The rhym potom is",
    "A. abc abc.",
    "B. aa bb cc",
    "C. ab ab cc.",
